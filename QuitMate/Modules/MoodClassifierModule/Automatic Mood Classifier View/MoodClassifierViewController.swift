...
private extension MoodClassifierViewController {
    ...
    func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            doneButton.heightAnchor.constraint(equalToConstant: 47),
            tryAgainButton.heightAnchor.constraint(equalToConstant: 47),
            manualMoodSelectionButton.heightAnchor.constraint(equalToConstant: 47)
        ])
    }
}
