    ...
    var body: some View {
        VStack(spacing: Spacings.spacing10) {
            ...
            Text(viewModel.explanatoryText)
                ...
                .minimumScaleFactor(0.6)
            Spacer()
            AdditionalInfoCell(leadingText: viewModel.dailyData, trailingText: "/ day")
            AdditionalInfoCell(leadingText: viewModel.weeklyData, trailingText: "/ week")
            AdditionalInfoCell(leadingText: viewModel.monthlyData, trailingText: "/ month")
            AdditionalInfoCell(leadingText: viewModel.yearlyData, trailingText: "/ year")
        }
        .padding()
